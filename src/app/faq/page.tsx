...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "আমাদের ডেলিভারি চার্জ ঢাকার ভেতরে ৬০ টাকা এবং ঢাকার বাইরে ১২০ টাকা। সাধারণত ঢাকা ও রাজশাহী সিটির ভেতরে ২৪ থেকে ৪৮ ঘণ্টার মধ্যে এবং অন্যান্য জেলায় ৩ থেকে ৫ কার্যদিবসের মধ্যে পার্সেল ডেলিভারি করা হয়।"
    },
    {
    ...
    },
    {
      ...
      a: "যদি প্রোডাক্টে কোনো ডিফেক্ট বা সমস্যা থাকে, তবে ডেলিভারি পাওয়ার ৭ দিনের মধ্যে আমাদের সাপোর্ট লাইনে (০১৩MD২২৩৫১৩) অথবা ইমেইলে যোগাযোগ করুন। আমরা সম্পূর্ণ ফ্রিতে প্রোডাক্টটি এক্সচেঞ্জ বা রিটার্ন করে দেব।"
    },
    {
